        ...
        <div className="bg-white dark:bg-[#151C28] rounded-2xl p-6 sm:p-7 border border-[#EAEAEA] dark:border-gray-800 shadow-[3px_3px_0_#202A5A] dark:shadow-[3px_3px_0_#59BBAF] flex flex-col justify-between">
          <div>
            <div className="flex items-center justify-between mb-3">
              ...
              <span className="text-xs text-ink-normal/60 dark:text-gray-400 font-bold">پردازش آنی</span>
            </div>
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              {SAMPLE_TEMPLATES.map((sample, idx) => (
                <button
                  ...
                  className="px-3 py-1.5 text-xs font-bold rounded-xl bg-gray-100 dark:bg-gray-800 hover:bg-ecosystem-light dark:hover:bg-ecosystem-darker/50 hover:text-ecosystem-darker dark:text-gray-200 border border-gray-200 dark:border-gray-700 transition-colors"
                >
                  {sample.title}
                </button>
              ))}
        ...
        <div className="bg-white dark:bg-[#151C28] rounded-2xl p-6 sm:p-7 border border-[#EAEAEA] dark:border-gray-800 shadow-[3px_3px_0_#202A5A] dark:shadow-[3px_3px_0_#59BBAF]">
          ...
          {parseResult.isValid ? (
            <div className="space-y-4">
              <div className="text-xs sm:text-sm text-ink-normal/70 dark:text-gray-300 font-bold">
                ...
                {parseResult.items.map((item, i) => (
                  ...
                  >
                    <div className="flex items-center gap-2.5">
                      ...
                      <span className="font-bold text-sec dark:text-white">{item.description}</span>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="p-4 sm:p-5 bg-female-light/60 dark:bg-female-darker/30 rounded-2xl border border-female-normal/30 text-xs sm:text-sm text-female-darker dark:text-female-light space-y-2">
