...
export default function AdminLoginPage() {
  ...
  return (
    <div
      ...
      dir="rtl"
    >
      <div className="w-full max-w-md bg-white dark:bg-[#151C28] rounded-2xl p-7 sm:p-9 border-2 border-primary/20 dark:border-gray-800 shadow-[4px_4px_0_#202A5A] dark:shadow-[4px_4px_0_#59BBAF]">
        {/* Header & Rotello Logo */}
        <div className="text-center mb-8">
          ...
          <p className="text-xs sm:text-sm text-ink-normal/70 dark:text-gray-400 mt-1.5 font-medium">
            سامانه یکپارچه مدیریت پروژه‌ها و کارها
          </p>
        </div>
        ...
        <div className="mt-8 pt-6 border-t border-gray-100 dark:border-gray-800 space-y-3">
          ...
          <p className="text-xs text-ink-normal/60 dark:text-gray-400 leading-relaxed font-medium">
            این بخش مختص راهبران و راهبران ارشد سامانه می‌باشد. در صورت فراموشی اطلاعات حساب کاربری، با راهبر ارشد سازمان در تماس باشید.
          </p>
        </div>
