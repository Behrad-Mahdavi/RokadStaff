...
export default function Sidebar({ onCloseMobile }: SidebarProps) {
  ...
  return (
    <aside className="w-72 bg-white dark:bg-[#121824] border-l border-[#EAEAEA] dark:border-gray-800 h-full flex flex-col justify-between shrink-0 shadow-[2px_0_10px_rgba(0,0,0,0.03)] dark:shadow-none z-50 transition-colors duration-200 overflow-y-auto">
      <div>
        {/* Brand Header */}
